...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.4\textwidth]{images/nae3sat_all_avg.png}}\hspace{30px}
...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.4\textwidth]{images/maxcut_all_avg.png}}\hspace{30px}
...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.4\textwidth]{images/skmodel_all_avg.png}}\hspace{30px}
