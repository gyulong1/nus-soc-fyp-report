...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.65\textwidth]{images/nae3sat_all_time_size.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.65\textwidth]{images/maxcut_all_time_size.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.65\textwidth]{images/skmodel_all_time_size.png}
