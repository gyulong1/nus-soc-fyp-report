...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.5\textwidth]{images/nae3sat_nnqs_avg.png}}
...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.5\textwidth]{images/maxcut_nnqs_avg.png}}
...
\begin{figure}[!htb]
    \centering
    \subfloat[Normalized energy]{\includegraphics[width=0.5\textwidth]{images/skmodel_nnqs_avg.png}}
